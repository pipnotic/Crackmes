...
include Eleven.Vars.inc
include Eleven.Func.asm
...
DlgProc PROC hWnd:HWND,uMsg:UINT,wParam:WPARAM,lParam:LPARAM 
	...
	.elseif uMsg == WM_COMMAND
		...
		.if eax == IDC_DECRYPT_CODE
			...
			; ecab4ccbd2377022f1f4a2175d8b376d was used to generate the current code
			...
			.if eax != 0				
				...
				.if eax != 0
					...
					push Hash
					call InitialiseHashTable
					
					; Use this value to decrypt the secret
					; push Hash
					call XorSecretString
					
					invoke MessageBox,hWindow,CTXT("You've got to ask yourself one question: Do I feel lucky? Well, do ya punk?"),CTXT("-=[ Status"),MB_OK
				.else
